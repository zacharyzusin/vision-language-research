...
#SBATCH --output=logs/sweep_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/sweep_%j.err     # Error file
...
# By default, agent runs until sweep is complete (all 5 K values)
