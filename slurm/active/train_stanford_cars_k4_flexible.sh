...
#SBATCH --job-name=mop_cars_k4       # Job name
...
#SBATCH --output=logs/train_cars_k4_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/train_cars_k4_%j.err     # Error file
...
echo ""
echo "=== Starting training with K=4 ==="
