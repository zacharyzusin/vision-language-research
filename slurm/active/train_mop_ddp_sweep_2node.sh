...
#SBATCH --nodes=2                     # Use 2 nodes (16 GPUs total - needed for 30 epochs in 12h)
...
#SBATCH --output=logs/sweep_2node_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/sweep_2node_%j.err     # Error file
