...
#SBATCH --job-name=mop_ucf101         # Job name
...
#SBATCH --output=logs/train_ucf101_k8_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/train_ucf101_k8_%j.err     # Error file
...
echo "Config: configs/ucf101.yaml"
echo "GPUs: $NPROC"
echo ""
