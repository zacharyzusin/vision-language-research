...
#SBATCH --job-name=mop_food101       # Job name
...
#SBATCH --output=logs/train_food101_k8_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/train_food101_k8_%j.err     # Error file
...
echo "Config: configs/food101.yaml"
echo "GPUs: $NPROC"
echo ""
