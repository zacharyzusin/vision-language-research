...
#SBATCH --job-name=mop_eurosat        # Job name
...
#SBATCH --output=logs/train_eurosat_k8_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/train_eurosat_k8_%j.err     # Error file
...
echo "Config: configs/eurosat.yaml"
echo "GPUs: $NPROC"
echo ""
