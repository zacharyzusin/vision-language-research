...
#SBATCH --job-name=mop_sun397         # Job name
...
#SBATCH --output=logs/train_sun397_k8_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/train_sun397_k8_%j.err     # Error file
...
echo "Config: configs/sun397.yaml"
echo "GPUs: $NPROC"
echo ""
