...
#SBATCH --job-name=mop_dtd            # Job name
...
#SBATCH --output=logs/train_dtd_k8_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/train_dtd_k8_%j.err     # Error file
