...
#SBATCH --job-name=mop_caltech101     # Job name
...
#SBATCH --output=logs/train_caltech101_k8_%j.out     # Output file (%j = job ID)
#SBATCH --error=logs/train_caltech101_k8_%j.err     # Error file
...
echo "Config: configs/caltech101.yaml"
echo "GPUs: $NPROC"
echo ""
